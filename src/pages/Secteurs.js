...
const Secteurs = () => {
    return (
        ...
        <section className='row'>
                ...
                <h1 className='title mt-5 mb-5 text-center'>Secteur</h1>
                    <p> Le Cabinet Devilder Avocats déploie ses expertises au profit de
                        ...
                        métier » dans les domaines concernés. Il s’agit notamment des secteurs
                        d’activité suivants :
                    </p>
