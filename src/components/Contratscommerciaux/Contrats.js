    ...
    <section>
      <div className="container-comp">
        <ul className='expertise-list'>
          ...
          <li>
            Mise en place de la stratégie contractuelle dès la création de
            l’entreprise et structuration de partenariats commerciaux ;
          </li>
          <li>
          ...
          <li>
            ...
            partenariats complexes, mise en place de joint-ventures, prestations
            de service, distribution, vente, contrat-cadre, etc.
          </li>
        </ul>
      </div>
    </section>
